...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">ABM-LARAVEL</a>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="alert alert-success alert-dismissible fade show" id="correcto" role="alert">
                    Success
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm" id="reload">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-success edit" id="{{ $user->id }}">
                                    ...
                                    <td>
                                        <button class="btn btn-danger delete" id="{{ $user->id }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
