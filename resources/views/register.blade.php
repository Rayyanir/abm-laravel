...
<body class="text-center">
    ...
    <main class="form-signin">
        <form action="/register-user" method="POST">
            @csrf
            <i class="mb-4" alt="" width="72" height="57">
                <svg xmlns="http://www.w3.org/2000/svg" width="72" height="57" fill="currentColor" class="bi bi-people"
                    viewBox="0 0 16 16">
                    <path
            ...
            @endif
            <button class="w-100 btn btn-lg btn-primary mt-4 mb-2" type="submit">Inicar Sesion</button>
            <a href="/" class="text-danger mt-5">Iniciar Sesion</a>
        </form>
    </main>
